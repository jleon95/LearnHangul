...
public class FromTranscriptionQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        for(int i = 0 ; i < nVowels ; i++) {
            ...
            characters.add(vowels.get(i).getCharacter());
        ...
        for(int i = 0 ; i < nConsonants ; i++) {
            ...
            characters.add(consonants.get(i).getCharacter());
        ...
        answerButtons.add((Button) findViewById(R.id.quiz2_first_option));
        answerButtons.add((Button) findViewById(R.id.quiz2_second_option));
        answerButtons.add((Button) findViewById(R.id.quiz2_third_option));
        answerButtons.add((Button) findViewById(R.id.quiz2_fourth_option));
        answerButtons.add((Button) findViewById(R.id.quiz2_fifth_option));
        answerButtons.add((Button) findViewById(R.id.quiz2_sixth_option));
    ...
    public void onBackPressed(){
        ...
        goBackWindow.showAtLocation(findViewById(R.id.layout_quiz_from_transcription), Gravity.CENTER,0,0);
    ...
    public void setNextQuestion(){
        ...
        TextView transcriptionText = (TextView) findViewById(R.id.quiz2_transcription);
