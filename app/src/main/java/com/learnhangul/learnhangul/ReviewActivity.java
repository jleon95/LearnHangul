...
public class ReviewActivity extends AppCompatActivity {
    ...
    private void setFromSCharacterButton(){

        final Button study = (Button) findViewById(R.id.button_review_syllable_from_character);
        study.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent goSyllableCharacterQuiz = new Intent(ReviewActivity.this, FromSCharacterQuizActivity.class);
                goSyllableCharacterQuiz.putExtra("com.learnhangul.learnhangul.syllables", syllables);
                startActivity(goSyllableCharacterQuiz);

            }
        });
    }

    private void setFromSTranscriptionButton(){

        final Button study = (Button) findViewById(R.id.button_review_syllable_from_transcription);
        study.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent goSyllableTranscriptionQuiz = new Intent(ReviewActivity.this, FromSTranscriptionQuizActivity.class);
                goSyllableTranscriptionQuiz.putExtra("com.learnhangul.learnhangul.syllables", syllables);
                startActivity(goSyllableTranscriptionQuiz);
